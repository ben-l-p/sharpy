...
class PazyWing:
    ...
    model_settings_default['sweep_angle'] = 0.
...
if __name__ == '__main__':
    ...
    instance_case_name = 'swept_pazy_wing'
    output_folder = './output/'

    view_wing(instance_case_name, './')
    case_data = sharpy.sharpy_main.main(['', instance_case_name + '.sharpy'])
